...
import { MapPin, Sun, Waves, Camera, ArrowRight } from "lucide-react";
...
const HIGHLIGHT_ICONS = [Sun, Waves, Camera, MapPin];
    ...
    <div className="w-full font-['Poppins']">
      ...
      >
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <h1 className="font-['Unbounded'] text-4xl md:text-5xl font-black text-white mb-6 uppercase tracking-tight">
            Zonas de Servicio
          </h1>
          <p className="text-xl text-white/70 max-w-2xl mx-auto leading-relaxed">
            Cubrimos los destinos mas exclusivos de Baja California Sur. Desde el aeropuerto hasta tu resort.
          </p>
        </div>
      </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          {isLoading ? (
            <div className="flex justify-center py-20">
              <div
                className="w-12 h-12 rounded-full border-4 border-transparent border-t-[#D4AF37] animate-spin"
              ...
              {zones?.map((zone, i) => (
                ...
                >
                  ...
                  <div className="w-full md:w-1/2 h-64 md:h-80 relative overflow-hidden">
                    ...
                    <h2 className="absolute bottom-5 left-5 text-2xl font-black text-white md:hidden">
                      {zone.name}
                    </h2>
                    {/* Zone number badge */}
                    <div className="absolute top-4 right-4 w-10 h-10 rounded-2xl bg-[#D4AF37] flex items-center justify-center">
                  ...
                  <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
                    ...
                    <h2 className="text-3xl font-black text-[#1C1917] mb-5 hidden md:block">
                      {zone.name}
                    </h2>
                    <p className="text-slate-600 leading-relaxed mb-8">{zone.description}</p>
                    ...
                    <Link
                      href={`/reservar`}
                      className="inline-flex items-center gap-2 bg-[#111111] hover:bg-[#1C1917] text-white font-bold text-sm px-6 py-3 rounded-2xl transition-colors w-fit"
                    >
                      Reservar desde aqui <ArrowRight className="w-4 h-4" />
                    </Link>
                  </div>
                </motion.div>
              ))}
